#include <vector>
#include "caffe/layers/upsample_layer_v2.hpp"

namespace caffe {

template <typename Dtype>
void UpsampleV2Layer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void UpsampleV2Layer<Dtype>::Reshape(
  const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void UpsampleV2Layer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void UpsampleV2Layer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(UpsampleLayerV2);
#endif

INSTANTIATE_CLASS(UpsampleV2Layer);
REGISTER_LAYER_CLASS(UpsampleV2);
